  ...
  F1.WorldBank.prototype = {
    init: function(map_id, maponload) {
      ...
      this.sectors = {
        ...
        "communications": {name: "Communications", funding: 0, projects: [], activities: 0, shortname: "communications", icon: "http://wbstaging.geocommons.com/images/icons/worldbank/communications-on.png"},
