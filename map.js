...
(function(){
  ...
  F1.WorldBank.prototype = {
    ...
    projectTable: function(data) {
        ...
        jq.each(["Project ID","Project Name","Financing Amount","Product Line","Major Sector","Approval Date"], function(index,header) {
    ...
    sectorPieChart: function(sector_name, refreshControls) {
        ...
        if (sector_name == 'none') {
            ...
            jq('#sector_funding_title').html("Active Portfolio for " + sector_names + " Sector")
        }
