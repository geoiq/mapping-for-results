...
info_templates = {
    infowindow: '<a href="" id="previous_project" style="display:none">&laquo;</a> <span id="project_index"><%= project_index %></span> of <span id="project_count"><%= project_count %></span> projects<a href="" id="next_project">&raquo;</a><br /><div id="project_info"></div>',
    project: '<div id="project_title"><h2><%= title %></h2><h3><img class="project_icon" src="<%= icon %>" /><%= sector %></h3></div> <div id="project_tabs"> <span class="tab_control tab_active" id="tab_about">About</span> <span class="tab_control" id="tab_locations">Locations</span> <span class="tab_control" id="tab_results">Results</span> </div> <div class="tab" id="tab_about_tab"><ul><li><em>Project ID</em>: <a target="_new" href="http://web.worldbank.org/external/projects/main?pagePK=64283627&piPK=73230&theSitePK=40941&menuPK=228424&Projectid=<%= project_id %>"><%= project_id %></a></li><li><em>Objective</em>:\n<%= development_objective %></li></ul> </div> </div> <div class="tab" id="tab_locations_tab" style="display:none"> <ul><li><em>Province:</em> <%= adm1 %></li><li><em>District:</em> <%= adm2 %></li><li><em>Geoname:</em> <%= geoname %></li><li><em>Description:</em>\n<%= precision_description %></li></ul> </div> <div class="tab" id="tab_results_tab" style="display:none"><a href="http://documents.worldbank.org/query?project=<%= project_id %>&docType=Implementation+Status+and+Results+Report" target="_new">Implementation Status and Results Report</a>\n<%= results %>'}
