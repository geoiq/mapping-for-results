...
table_templates = {
    ...
    mine: '<tr id="row_<%= id %>" class="<%= even %>" project-id="<%= Company_name %>"><td><a href="<%= CompanyURL %>" target="_new"><%= Company_name %></a></td><td><%= mineral_type %></td><td><%= Total_company_payments %></td><td><%= Total_government_receipts %></td><td><%= Total_difference %></td><td><a href="<%= CSR_url %>" target="_new"><%= Sustainability_reports_available %></a></td></tr>'
};
