...
info_templates = {
    ...
    project: '<div id="project_title"><%= image %><h2><%= title %></h2><h3><img class="project_icon" src="<%= icon %>" /><%= sector %></h3></div> <div id="project_tabs"> <span class="tab_control tab_active" id="tab_about">About</span> <span class="tab_control" id="tab_locations">Location</span> <span class="tab_control" id="tab_results">Results</span> </div> <div class="tab" id="tab_about_tab"><%= development_objective %> <a target="_new" href="http://web.worldbank.org/external/projects/main?pagePK=64283627&piPK=73230&theSitePK=40941&menuPK=228424&Projectid=<%= project_id %>">More Information &raquo;</a></div> </div> <div class="tab" id="tab_locations_tab" style="display:none"> <ul><li><em>Province:</em> <%= adm1 %></li><li><em>District:</em> <%= adm2 %></li><li><em>Project Site:</em> <%= geoname %></li></ul> </div> <div class="tab" id="tab_results_tab" style="display:none"><%= results_blurb %><br /><a href="http://documents.worldbank.org/query?project=<%= project_id %>&docType=Implementation+Status+and+Results+Report" target="_new">Implementation Status and Results Report</a><br /><a href="<%= results %>" target="_new">Results Profile</a><br /><%= links %>'}
